...
export function UsageView() {
  ...
  const resume = (row: UsageSessionRow) => {
    useApp.getState().openLauncher({ provider: row.provider, profileId: row.profileId, cwd: row.cwd ?? settings?.defaultCwd, mode: 'interactive', resumeSessionId: row.sessionId, title: row.title ?? undefined });
  };
